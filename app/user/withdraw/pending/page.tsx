...
function PendingWithdrawPageContent() {
  ...
  const fetchHistory = async () => {
    ...
    try {
      ...
      console.error("Failed to fetch pending withdraw history:", err);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="relative z-10">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-light tracking-tight text-white flex items-center gap-3">
            <Clock3 className="text-yellow-400" /> Pending Withdrawals
          </h1>
          <p className="mt-2 text-white/50">
            View withdrawal requests currently awaiting OTP confirmation or admin processing.
          </p>
        </div>
        ...
        <div className="rounded-[34px] border border-white/10 bg-white/5 p-4 lg:p-6 shadow-[0_35px_80px_rgba(0,0,0,.45)] backdrop-blur-3xl">
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-medium text-white">Pending Requests</h2>
            </div>
